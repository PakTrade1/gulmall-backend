...
func Add_shipping_address(w http.ResponseWriter, req *http.Request) {
	...
	mongo_query := bson.M{
		"Address": bson.A{
			bson.M{
				"name":        shipping_req.Address.Name,
				"line_1":      shipping_req.Address.Line_1,
				"line_2":      shipping_req.Address.Line_2,
				"subrub":      shipping_req.Address.Subrub,
				"city":        shipping_req.Address.City,
				"postal_code": shipping_req.Address.Postal_code,
			},
		},
