				...
				bson.D{
					{"$or",
						bson.A{
							...
							bson.D{{"item.fabric", bson.D{{"$regex", keyserch.Keyword}}}},
							bson.D{{"item.careInstructions", bson.D{{"$regex", keyserch.Keyword}}}},
							bson.D{{"item.clothType", bson.D{{"$regex", keyserch.Keyword}}}},
						},
					},
				},
			},
